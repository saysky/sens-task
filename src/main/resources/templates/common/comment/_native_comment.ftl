<@compress single_line=true>
    <link type="text/css" rel="stylesheet" href="${options.blog_static_url?if_exists}/static/plugins/OwO/OwO.min.css?version=1.5.0">
    <style>
                ...
                <ul class="comment-list children">
                    <#if comments?? && comments?size gt 0>
                        <#list comments?sort_by("createTime") as comment>
                            <li class="comment even thread-even parent" id="comment-id-${comment.id?c}">
                                <div class="comment-body">
                                    <div class="comment-author vcard">
                                        ...
                                        <span class="comment-aux">
                                            <span class="reply">
                                                <a rel="nofollow" at="${comment.id?c}"
                                        ...
                                        ${comment.createTime?string("yyyy-MM-dd HH:mm")}
                                            <#if isAuthor?if_exists>
                                                <a class="comment-delete-link" data-id="${comment.id}"
    ...
    <script src="${options.blog_static_url?if_exists}/static/plugins/md5/md5.min.js?version=1.5.0"></script>
    <script src="${options.blog_static_url?if_exists}/static/plugins/ua-parser/ua-parser.min.js?version=1.5.0"></script>
