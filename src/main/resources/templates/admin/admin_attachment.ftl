            ...
            <div class="row">
                ...
                <div id="attachment-box">
                    <#list attachments as attachment>
                        <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 div-thumbnail"
                             onclick="openDetail(${attachment.id?c})">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="no-margin pull-left">
                        ...
                        <span id="pageNum">${pageInfo.current}</span>
                    ...
                    <ul class="pagination no-margin pull-right">
                        ...
                        <li><a data-pjax="true" class="btn btn-sm <#if !hasPrevious>disabled</#if>"
                               href="/admin/attachment?page=${pageInfo.current-1}"><@spring.message code='admin.pageinfo.btn.pre' /></a>
                        </li>
                        <li><a data-pjax="true" class="btn btn-sm <#if !hasNext>disabled</#if>"
                               href="/admin/attachment?page=${pageInfo.current+1}"><@spring.message code='admin.pageinfo.btn.next' /></a>
                        </li>
                        <li><a data-pjax="true" class="btn btn-sm <#if !hasNext>disabled</#if>"
                               href="/admin/attachment?page=${pageInfo.pages}"><@spring.message code='admin.pageinfo.btn.last' /></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <script type="application/javascript">
            function openDetail(id) {
                layer.open({
                    ...
                    maxmin: true,
                    area: ['90%', '90%'],
                    content: '/admin/attachment/detail?id=' + id,
                    scrollbar: false
                });
            }
