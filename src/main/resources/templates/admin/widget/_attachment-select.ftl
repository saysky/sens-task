                ...
                <div class="tab-pane active" id="allAttach">
                    <div class="row">
                        ...
                        <#assign hasPrevious = (pageInfo.current > 1)>
                            ...
                            <@spring.message code='admin.pageinfo.text.no' /> <span id="pageNum">${pageInfo.current}</span>
                            ...
                            <ul class="pagination no-margin pull-right">
                                ...
                                <li><a class="btn btn-sm <#if !hasNext>disabled</#if>"
                                       href="/admin/attachment/select?page=${pageInfo.pages}"><@spring.message code='admin.pageinfo.btn.last' /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
