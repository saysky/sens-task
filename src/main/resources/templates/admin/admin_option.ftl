                ...
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="#third-party"
                                   data-toggle="tab"><@spring.message code='admin.setting.tab.third-party' /></a>
                            </li>
                            <li>
                                <a href="#theme"
                                   data-toggle="tab">主题设置</a>
                            </li>
                            <li>
                                <a href="#other"
                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <select class="form-control" id="blogLocale" name="blog_locale">
                                                    <option value="zh_CN" ${((options.blog_locale?default('zh_CN'))=='zh_CN')?string('selected','')}>
                                                        简体中文
                                                    </option>
                                                    <option value="en_US" ${((options.blog_locale?if_exists)=='en_US')?string('selected','')}>
                                                        English
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <textarea class="form-control" rows="5" id="blogFooterInfo"
                                                          ...
                                                          style="resize: none">${options.blog_footer_info?if_exists}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="keywords"
                                                       name="seo_keywords" value="${options.seo_keywords?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="desc"
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="desc" name="seo_desc"
                                                       value="${options.seo_desc?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="baiduToken"
                                                           ...
                                                           value="${options.seo_baidu_token?if_exists}">
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default " id="btn_push_baidu"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="blogVerificationGoogle"
                                                       ...
                                                       value="${options.blog_verification_google?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="blogVerificationBing"
                                                       ...
                                                       value="${options.blog_verification_bing?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="blogVerificationBaidu"
                                                       ...
                                                       value="${options.blog_verification_baidu?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="blogVerificationQihu"
                                                       ...
                                                       value="${options.blog_verification_qihu?if_exists}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-footer">
                                ...
                                <form method="post" class="form-horizontal" id="postOptions">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="number" class="form-control" id="indexPosts"
                                                       name="index_posts" value="${options.index_posts?default('10')}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="rssPosts"
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="number" class="form-control" id="rssPosts" name="rss_posts"
                                                       value="${options.rss_posts?if_exists}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="postSummary"
                                                           name="post_summary"
                                                           value="${options.post_summary?default('50')}">
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default " id="btn_update_summary"
                                        ...
                                        <!-- 搜索是否开启ES -->
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-4 control-label">搜索是否开启ES</label>
                                            <div class="col-lg-4 col-sm-8 control-radio">
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="open_elasticsearch"
                                                           value="true" ${((options.open_elasticsearch?default('true'))=='true')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.enable' /></label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="open_elasticsearch"
                                                           value="false" ${((options.open_elasticsearch?if_exists)=='false')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.disable' /></label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.comment-system' />
                                                <span data-toggle="tooltip" data-placement="top"
                                                      title="<@spring.message code='admin.setting.form.comment-system-tips' />"
                                                      style="cursor: pointer">
                                                    <i class="fa fa-question-circle" aria-hidden="true"></i>
                                                </span>
                                            </label>
                                            <div class="col-lg-4 col-sm-8 control-radio">
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="comment_system"
                                                           value="native" ${((options.comment_system?default('native'))=='native')?string('checked','')}>
                                                    <div class="state p-primary">
                                                ...
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="comment_system"
                                                           value="valine" ${((options.comment_system?default('native'))=='valine')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label>Valine</label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="comment_system"
                                                           value="disqus" ${((options.comment_system?default('native'))=='disqus')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label>Disqus</label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="comment_system"
                                                           value="livere" ${((options.comment_system?default('native'))=='livere')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label>Livere</label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="native-options" style="display: none">
                                            <div class="form-group">
                                                <label for="nativeCommentAvatar"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.native-comment-avatar' />
                                                    <span data-toggle="tooltip" data-placement="top"
                                                          title="<@spring.message code='admin.setting.form.native-comment-avatar-tips' />"
                                                          style="cursor: pointer">
                                                        <i class="fa fa-question-circle" aria-hidden="true"></i>
                                                    </span>
                                                </label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <select class="form-control" id="nativeCommentAvatar"
                                                        ...
                                                        <option value="wavatar" ${((options.native_comment_avatar?default('default'))=='wavatar')?string('selected','')}>
                                                            Wavatar
                                                        </option>
                                                ...
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="new_comment_need_check"
                                                               value="true" ${((options.new_comment_need_check?default("true"))=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="new_comment_need_check"
                                                               value="false" ${((options.new_comment_need_check?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="new_comment_notice"
                                                               value="true" ${((options.new_comment_notice?if_exists)=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="new_comment_notice"
                                                               value="false" ${((options.new_comment_notice?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="comment_pass_notice"
                                                               value="true" ${((options.comment_pass_notice?if_exists)=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="comment_pass_notice"
                                                               value="false" ${((options.comment_pass_notice?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="comment_reply_notice"
                                                               value="true" ${((options.comment_reply_notice?if_exists)=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="comment_reply_notice"
                                                               value="false" ${((options.comment_reply_notice?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="number" class="form-control" id="indexComments"
                                                           name="index_comments"
                                                           value="${options.index_comments?default('10')}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="url" class="form-control" id="nativeCommentPlaceholder"
                                                           ...
                                                           value="${options.native_comment_placeholder?default('赶快评论一个吧！')}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="nativeCss"
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <textarea class="form-control" rows="5" id="nativeCss"
                                                              name="native_css"
                                                              style="resize: none">${options.native_css?if_exists}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="valine-options" style="display: none">
                                            <div class="form-group">
                                                <label for="valineAppId" class="col-lg-2 col-sm-4 control-label">APP
                                                    ID：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="valineAppId"
                                                           name="valine_appid"
                                                           value="${options.valine_appid?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="valineAppKey" class="col-lg-2 col-sm-4 control-label">APP
                                                    KEY：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="valineAppKey"
                                                           name="valine_appkey"
                                                           value="${options.valine_appkey?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="valineAvatar"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.valine-avatar' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="valineAvatar"
                                                           name="valine_avatar"
                                                           value="${options.valine_avatar?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="valinePlaceholder"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.valine-placeholder' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="valinePlaceholder"
                                                           name="valine_placeholder"
                                                           value="${options.valine_placeholder?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="valineCss"
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <textarea class="form-control" rows="5" id="valineCss"
                                                              name="valine_css"
                                                              style="resize: none">${options.valine_css?if_exists}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="disqus-options" style="display: none">
                                            <div class="form-group">
                                                <label for="disqusShortname" class="col-lg-2 col-sm-4 control-label">Disqus
                                                    ShortName：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="disqusShortname"
                                                           name="disqus_shortname"
                                                           value="${options.disqus_shortname?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="disqusCss"
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <textarea class="form-control" rows="5" id="disqusCss"
                                                              name="disqus_css"
                                                              style="resize: none">${options.disqus_css?if_exists}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="livere-options" style="display: none">
                                            <div class="form-group">
                                                <label for="livereDataUid" class="col-lg-2 col-sm-4 control-label">livere
                                                    data-uid：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="livereDataUid"
                                                           name="livere_data_uid"
                                                           value="${options.livere_data_uid?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="livereCss"
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <textarea class="form-control" rows="5" id="livereCss"
                                                              name="livere_css"
                                                              style="resize: none">${options.livere_css?if_exists}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="changyan-options" style="display: none">
                                            <div class="form-group">
                                                <label for="changyanAppId" class="col-lg-2 col-sm-4 control-label">APP
                                                    ID：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="changyanAppId"
                                                           name="changyan_appid"
                                                           value="${options.changyan_appid?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="changyanConf"
                                                       class="col-lg-2 col-sm-4 control-label">CONF：</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="changyanConf"
                                                           name="changyan_conf"
                                                           value="${options.changyan_conf?if_exists}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="changyanCss"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.comment-css' />
                                                    <span data-toggle="tooltip" data-placement="top"
                                                          title="<@spring.message code='admin.setting.form.comment-css-tips' />"
                                                          style="cursor: pointer">
                                                ...
                                                <div class="col-lg-4 col-sm-8">
                                                    <textarea class="form-control" rows="5" id="changyanCss"
                                                              name="changyan_css"
                                                              style="resize: none">${options.changyan_css?if_exists}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="admin">
                                <form method="post" class="form-horizontal" id="adminOptions">
                                    <div class="box-body">
                                        ...
                                        <!-- 默认注册角色 -->
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.settings.form.default-register-role' /></label>
                                            <div class="col-lg-10 col-sm-8 control-radio">
                                                <#list roles as role>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="default_register_role"
                                                           value="${role.role}" ${(options.default_register_role?default("subscriber") == role.role)?string('checked','')}>
                                                    <div class="state p-primary">
                                            ...
                                            <div class="col-lg-4 col-sm-8 control-radio">
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="smtp_email_enable"
                                                           value="true" ${((options.smtp_email_enable?default('false'))=='true')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.enable' /></label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="smtp_email_enable"
                                                           value="false" ${((options.smtp_email_enable?if_exists)=='false')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.disable' /></label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="emailSmtpHost"
                                                       name="mail_smtp_host" value="${options.mail_smtp_host?if_exists}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="email" class="form-control" id="emailSmtpUserName"
                                                       ...
                                                       value="${options.mail_smtp_username?if_exists}"
                                                       autocomplete="email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="password" class="form-control" id="emailSmtpPassword"
                                                       ...
                                                       value="${options.mail_smtp_password?if_exists}" current-password>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="emailFromName"
                                                       name="mail_from_name" value="${options.mail_from_name?if_exists}"
                                                       autocomplete="name">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- 第三方登录设置 -->
                            <div class="tab-pane" id="third-party">
                                <form method="post" class="form-horizontal" id="bindOptions">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.third-app' /></label>
                                            <div class="col-lg-4 col-sm-8 control-radio">
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="bind_type" value="bind-qq" checked>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='admin.setting.form.bind-qq' /></label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="bind_type" value="bind-github">
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='admin.setting.form.bind-github' /></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- QQ -->
                                        <div class="bind-qq-options">
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-open' /></label>
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="bind_qq_open"
                                                               value="true" ${((options.bind_qq_open?if_exists)=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="bind_qq_open"
                                                               value="false" ${((options.bind_qq_open?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label for="bindQqAppId"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-qq-app-id' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindQqAppId"
                                                           name="bind_qq_app_id" value="${options.bind_qq_app_id!}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="bindQqAppSecret"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-qq-app-secret' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindQqAppSecret"
                                                           name="bind_qq_app_secret"
                                                           value="${options.bind_qq_app_secret!}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="bindQqCallback"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-qq-callback' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindQqCallback"
                                                           name="bind_qq_callback" value="${options.bind_qq_callback!}">
                                                </div>
                                            </div>
                                        </div>

                                        <!-- GitHub -->
                                        <div class="bind-github-options">
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-open' /></label>
                                                <div class="col-lg-4 col-sm-8 control-radio">
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="bind_github_open"
                                                               value="true" ${((options.bind_github_open?if_exists)=='true')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.enable' /></label>
                                                        </div>
                                                    </div>
                                                    <div class="pretty p-default p-round">
                                                        <input type="radio" name="bind_github_open"
                                                               value="false" ${((options.bind_github_open?if_exists)=='false')?string('checked','')}>
                                                        <div class="state p-primary">
                                                            <label><@spring.message code='common.radio.disable' /></label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label for="bindGithubAppId"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-github-app-id' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindGithubAppId"
                                                           name="bind_github_app_id"
                                                           value="${options.bind_github_app_id!}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="bindGithubAppSecret"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-github-app-secret' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindGithubAppSecret"
                                                           name="bind_github_app_secret"
                                                           value="${options.bind_github_app_secret!}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="bindGithubCallback"
                                                       class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.bind-github-callback' /></label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="text" class="form-control" id="bindGithubCallback"
                                                           name="bind_github_callback"
                                                           value="${options.bind_github_callback!}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        <button type="button" class="btn btn-primary btn-sm "
                                                onclick="saveOptions('bindOptions')"><@spring.message code='common.btn.save' /></button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane" id="theme">
                                <form method="post" class="form-horizontal" id="beginSnsOptions">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="beginSnsRss" class="col-lg-2 col-sm-4 control-label">RSS：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsWeixin" class="col-lg-2 col-sm-4 control-label">微信二维码：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsWeibo" class="col-lg-2 col-sm-4control-label">Weibo：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsEmail" class="col-lg-2 col-sm-4 control-label">Email：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsGithub" class="col-lg-2 col-sm-4 control-label">Github：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsQQ" class="col-lg-2 col-sm-4 control-label">QQ：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" class="form-control" id="beginSnsQQ" name="theme_begin_sns_qq" value="${options.theme_begin_sns_qq?if_exists}" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="beginSnsAboutPicture" class="col-lg-2 col-sm-4 control-label">关于本站头像：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsAboutNickname" class="col-lg-2 col-sm-4 control-label">关于本站昵称：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginSnsAboutDesc" class="col-lg-2 col-sm-4 control-label">关于本站说明：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="beginPostFooterIsDisplay" class="col-lg-2 col-sm-4 control-label">正文底部二维码是否显示：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <label class="radio-inline">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterLeftTitle" class="col-lg-2 col-sm-4 control-label">正文底部左侧标题：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterLeftDesc" class="col-lg-2 col-sm-4 control-label">正文底部左侧说明：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterLeftPic" class="col-lg-2 col-sm-4 control-label">正文底部左侧图片：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterRightTitle" class="col-lg-2 col-sm-4 control-label">正文底部右侧标题：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterRightDesc" class="col-lg-2 col-sm-4 control-label">正文底部右侧说明：</label>
                                            <div class="col-lg-4 col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="beginPostFooterRightPic" class="col-lg-2 col-sm-4 control-label">正文底部右侧图片：</label>
                                            <div class="col-lg-4 col-sm-8">
                                                <div class="input-group">
                                    ...
                                    <div class="box-footer">
                                        <button type="button" class="btn btn-primary btn-sm pull-right" onclick="saveOptions('themeOptions')">保存设置</button>
                                    </div>
                                </form>
                            </div>
                                            ...
                                            <div class="col-lg-4 col-sm-8 control-radio">
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="api_status"
                                                           value="true" ${((options.api_status?if_exists)=='true')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.enable' /></label>
                                                    </div>
                                                </div>
                                                <div class="pretty p-default p-round">
                                                    <input type="radio" name="api_status"
                                                           value="false" ${((options.api_status?default('false'))=='false')?string('checked','')}>
                                                    <div class="state p-primary">
                                                        <label><@spring.message code='common.radio.disable' /></label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-8">
                                                <textarea class="form-control" rows="6" id="statisticsCode"
                                                          ...
                                                          style="resize: none">${options.statistics_code?if_exists}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="commentRubbishWords"
                                                   class="col-lg-2 col-sm-4 control-label"><@spring.message code='admin.setting.form.comment-rubbish-words' />
                                            </label>
                                            <div class="col-lg-4 col-sm-8">
                                                <textarea class="form-control" rows="6" id="commentRubbishWords"
                                                          name="comment_rubbish_words"
                                                          style="resize: none">${options.comment_rubbish_words?if_exists}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-footer">
    ...
    <@compress single_line=true>
        <script>
            ...
            function updateAllSummary() {
                $.ajax({
                    type: 'POST',
                    url: '/admin/post/resetAllSummary',
                    data: {
