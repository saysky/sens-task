                                                ...
                                                <td>
                                                    ...
                                                    <#else>
                                                        <a data-pjax="true"
                                                           ...
                                                           class="btn btn-primary btn-xs "><@spring.message code='common.btn.modify' />
                                                        </a>
                                                    </#if>
                                                    <button class="btn btn-danger btn-xs "
                                                            onclick="modelShow('/admin/permission/delete?id=${permission.id?c}')"><@spring.message code='common.btn.delete' /></button>
                                                </td>
                                            </tr>
                                        </#list>
                                        </tbody>
